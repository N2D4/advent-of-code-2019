...
@CacheVersion(0)
public class D15_2_OxygenSystem extends AbstractSubmission {
                    ...
                    try {
                        switch (directions.size() == 0 ? 1 : output.take().intValueExact()) {
                            ...
                            case 1: case 2: {
                                ...
                                if (maxDist < directions.size()) {
                                    debug.println("Found new maxDist! " + el + " " + directions.size());
                                    maxDist = directions.size();
                                }
                                break;
                            }
                            default: {
                        ...
                        for (int i = 0; i < directions.size(); i++) {
                            assert !output.take().equals(ZERO);
                        }
                        assert output.size() == 0;
                    }
                }
    ...
    public static void main(String[] args) throws Exception {
        buildAndRun(D15_2_OxygenSystem.class, System.getProperty("user.home") + "/Downloads", "unique_id_D2_1_1202ProgramAlert_02.12.19_15:11_Advent of Code");
    }

    public D15_2_OxygenSystem() {
