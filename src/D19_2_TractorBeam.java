...
@CacheVersion(0)
public class D19_2_TractorBeam extends AbstractSubmission {
    ...
    public BigInteger solve(BigInteger[] code, int i, int j) throws InterruptedException {
        //debug.println(i + " " + j);
        ...
        try {
            ...
            while (true) {
                ...
                if (n.equals(ZERO)) {
                    ...
                    if (solve(code, i-ko+1, j+ko-1).equals(ONE) && solve(code, i-ko+1, j).equals(ONE)) {
                        out.println((j - 0) * 10_000 + (i - ko+1));
                        return;
                    }
                    i++;
                }
    ...
    public static void main(String[] args) throws Exception {
        buildAndRun(D19_2_TractorBeam.class, System.getProperty("user.home") + "/Downloads", "unique_id_D2_1_1202ProgramAlert_02.12.19_15:11_Advent of Code");
    }

    public D19_2_TractorBeam() {
